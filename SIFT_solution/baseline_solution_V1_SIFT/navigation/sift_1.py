...
class Exploration:
    def __init__(self, dir, targ_dir, num_clusters=64):
        ...
        codebook_path = current_path + "/baseline_solution_V1_SIFT/navigation/codebook_new.pkl"
        print()
        print(codebook_path)
        print()
...
exploration = Exploration(current_path + "/baseline_solution_V1_SIFT/dataset/images/demo_2/",
                          current_path + "/baseline_solution_V1_SIFT/test/")
exploration.run()
